...
export default function Chains() {
  return (
    <section data-theme="halloween" className=" flex flex-col items-center gap-10 py-10">
      <h1 className="text-3xl font-bold text-center pt-10">
        Tokenize on leading EVM chains
      </h1>
      <div  className="carousel max-md:carousel-vertical max-md:items-center max-md:gap-10 carousel-center max-w-6xl p-4 space-x-4 bg-base-100 rounded-box pb-10">
        <div className="carousel-item max-md:h-full px-4">
          <Image
            src={avalanche}
            height={30}
          />
