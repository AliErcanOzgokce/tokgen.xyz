...
export default function HowItWorks() {
  return (
    <section className="flex flex-col items-center pt-20 gap-10">
      ...
      <ul className="timeline timeline-vertical xl:hidden max-md:w-5/6">
        <li>
          <div className="timeline-start mb-10 max-w-xs timeline-box border-primary flex flex-col gap-5 py-10 px-5 justify-center text-center">
            <div className="w-full flex justify-center">
              <Image src={wallet} height={80} />
        ...
        <li>
          ...
          <div className="timeline-end mb-10 max-w-xs timeline-box border-primary flex flex-col gap-5 py-10 px-5 justify-center text-center">
            <div className="w-full flex justify-center">
              <Image src={token} height={80} />
            </div>
            <div className="text-lg font-black">Enter Token Details</div>
