...
// async function deployContract(features, address, name, symbol, premint, chain, chainId) {
...
//           // Construct the path to the JSON file containing the ABI
...
//           );
//           console.log("ABI File Path:", abiFilePath);
...
//           } catch (error) {
//             console.error("Error reading ABI file or transferring tokens:", error);
//             reject(error);
//           }
...
// const fs = require("fs");
// const path = require("path");
// const { default: transferTokens } = require("./transferTokens");
...
//           console.log("ABI:", abi);
//           console.log("Transfering tokens to the Owner...");
//           // Pass the ABI to the transferTokens function
//           await transferTokens(contractAddress, address, premint, chain, chainId, abi);
//           console.log(`Contract deployed at: ${contractAddress}`);
//           resolve(contractAddress);
//         } else {
//           const errorMessage = "Could not find contract address in output.";
